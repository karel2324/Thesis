...
-- ===============================================================
-- 0) CONFIG (kleine helper: maak cfg inline in elke statement)
-- ===============================================================

/* ===============================================================
   1) VISIT TIMES  (visit-level constant)
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.visit_times` AS
SELECT
  vo.person_id,
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.death` AS
SELECT
  person_id,
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.demographics` AS
SELECT
  p.person_id,
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.var_map` AS
WITH cfg AS (
  SELECT * FROM `windy-forge-475207-e3.derived.cfg_params` LIMIT 1
)
SELECT
  v.var,
  v.lb_h,
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.gcs_map` AS
WITH cfg AS (
  SELECT * FROM `windy-forge-475207-e3.derived.cfg_params` LIMIT 1
)
SELECT
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.weight_first_person` AS
WITH
cfg AS (
  SELECT * FROM `windy-forge-475207-e3.derived.cfg_params` LIMIT 1
),
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.weight_effective_person` AS
WITH dem AS (
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.uo_rates` AS
WITH
cfg AS (
  SELECT * FROM `windy-forge-475207-e3.derived.cfg_params` LIMIT 1
),
...
w AS (
  ...
  FROM `windy-forge-475207-e3.derived.weight_effective_person`
)
SELECT
  u.person_id,
