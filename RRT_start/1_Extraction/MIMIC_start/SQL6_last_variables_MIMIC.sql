...
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.grid_last_var_long` AS
WITH
/* ===============================================================
...
candidates AS (
  SELECT
    ...
    m.ts
  FROM grid g
  JOIN `windy-forge-475207-e3.derived_mimic.cohort_measurements_window_stat_valid` m
