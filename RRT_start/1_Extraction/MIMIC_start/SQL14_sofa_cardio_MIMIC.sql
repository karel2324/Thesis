...
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.sofa_cardio_24h` AS
WITH
/* ===============================================================
   0) CONFIG
   =============================================================== */
...
map_24h_current AS (
  ...
  FROM grid g
  LEFT JOIN `windy-forge-475207-e3.derived_mimic.cohort_measurements_window_stat_valid` m
