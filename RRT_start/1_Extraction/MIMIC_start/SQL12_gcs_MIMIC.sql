...
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.cohort_gcs_grid` AS
WITH
/* ===============================================================
   0) CONFIG
   =============================================================== */
...
gcs_meas AS (
  ...
  JOIN `windy-forge-475207-e3.derived_mimic.cohort_grid` g ON g.stay_id = ce.stay_id
