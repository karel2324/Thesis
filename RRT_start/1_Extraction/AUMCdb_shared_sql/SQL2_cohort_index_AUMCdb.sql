...
weight_effective AS (
  SELECT * FROM `windy-forge-475207-e3.${DATASET}.weight_effective_person`
),
weight_first AS (
...
/* ===============================================================
   3) KDIGO - URINE OUTPUT EVENTS (bron = ${DATASET}.uo_rates util)
   =============================================================== */
uo_events AS (
  SELECT DISTINCT
    person_id,
...
/* ===============================================================
   ...
   CHANGED: Added window_end based on cfg.obs_days (7 dagen)
   =============================================================== */
bloodflow_raw AS (
  SELECT
    m.person_id,
