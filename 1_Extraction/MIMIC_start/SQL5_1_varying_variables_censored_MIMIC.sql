...
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.cohort_measurements_window_stat_valid` AS
SELECT
  subject_id,
  hadm_id,
  stay_id,
...
FROM `windy-forge-475207-e3.derived_mimic.cohort_measurements_window`
