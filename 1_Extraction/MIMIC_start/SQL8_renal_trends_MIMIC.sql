...
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.grid_renal_trends` AS
WITH
/* ===============================================================
...
/* ===============================================================
   3) MINIMUM WITHIN 48h AND 7d BEFORE GRID
   =============================================================== */
min_windows AS (
  SELECT
    g.subject_id,
...
/* ===============================================================
   ...
   =============================================================== */
uo_rates AS (
  SELECT * FROM `windy-forge-475207-e3.derived_mimic.uo_rates`
),
