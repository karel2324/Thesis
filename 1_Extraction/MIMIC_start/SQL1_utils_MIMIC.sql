...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.visit_times` AS
SELECT
  ie.subject_id,
  ie.hadm_id,
  ie.stay_id,
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.demographics` AS
SELECT
  subject_id,
  gender,
  anchor_age,
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.death` AS
SELECT
  subject_id,
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.icu_admission_age` AS
SELECT
  ie.subject_id,
  ie.hadm_id,
  ie.stay_id,
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.var_map` AS
WITH cfg AS (
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.gcs_map` AS
WITH cfg AS (
  SELECT * FROM `windy-forge-475207-e3.derived_mimic.cfg_params` LIMIT 1
)
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.weight_first_stay` AS
WITH cfg AS (
  SELECT * FROM `windy-forge-475207-e3.derived_mimic.cfg_params` LIMIT 1
),
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.weight_effective_stay` AS
WITH dem AS (
  SELECT subject_id, gender
  FROM `windy-forge-475207-e3.derived_mimic.demographics`
),
...
/* ===============================================================
   ...
   =============================================================== */
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived_mimic.uo_rates` AS
WITH cfg AS (
  SELECT * FROM `windy-forge-475207-e3.derived_mimic.cfg_params` LIMIT 1
),
...
w AS (
  ...
  FROM `windy-forge-475207-e3.derived_mimic.weight_effective_stay`
)
