CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.cohort_grid` AS
WITH
/* ===============================================================
   0) CONFIG
   =============================================================== */
...
/* ===============================================================
   2) GRID GENERATIE (ruim, nog niet gecensureerd)
   =============================================================== */
base_grid AS (
  SELECT
    c.person_id,
...
grid AS (
  SELECT
    ...
    -- laatste geldige grid vóór of op terminal
    MAX(
      IF(
    ...
    -- type terminal event (only on terminal step, like MIMIC)
    CASE
