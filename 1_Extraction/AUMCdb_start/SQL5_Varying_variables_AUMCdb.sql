...
CREATE OR REPLACE TABLE `windy-forge-475207-e3.derived.cohort_measurements_window` AS
WITH
/* ===============================================================
   0) CONFIG
   =============================================================== */
...
concept_map AS (
  ...
  FROM `windy-forge-475207-e3.derived.var_map` vm
...
cohort_window AS (
  ...
  FROM `windy-forge-475207-e3.derived.cohort_static_variables` c
  CROSS JOIN cfg
),
